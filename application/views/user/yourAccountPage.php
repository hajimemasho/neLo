<!-- fisier php ce afiseaza contul utilizatorului logat -->
<?php	
	session_start(); 
...
<html>
	...
	<body>				
		<section>
			<ul>
				<li><a href="<?php echo $personalInfo; ?>">Informatii personale</a></li>
				<li><a href="<?php echo $reservationsHistory ?>">Istoric rezervari</a></li>
				<li><a href="<?php echo $logoutPage ?>">Iesire cont</a></li>
			<ul>
		</section>
